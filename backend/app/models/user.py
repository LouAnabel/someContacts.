...
class User(db.Model):
    ...
    emails = db.relationship('UserEmail', backref='contact', lazy='dynamic', cascade='all, delete-orphan')
    phones = db.relationship('UserPhone', backref='contact', lazy='dynamic', cascade='all, delete-orphan')
    addresses = db.relationship('UserAddress', backref='contact', lazy='dynamic', cascade='all, delete-orphan')
    links = db.relationship('UserLink', backref='contact', lazy='dynamic', cascade='all, delete-orphan')
    ...
    def to_dict(self, include_phones=True, include_emails=True, include_addresses=True, include_links=True):
