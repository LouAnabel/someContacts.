         ...
         <div className="min-h-screen bg-white w-full dark:bg-black relative justify-items mx-auto px-4 py-10" 
            ...
            <div className="bg-gray-50 rounded-3xl p-5 z-10 overflow-visible w-[88vw] min-w-[260px] max-w-[380px] h-fit absolute left-1/2 transform -translate-x-1/2"
                ...
                <div className="w-full relative justify-items flex flex-col mt-5 mb-4 space-y-1">
                    ...
                    <div class="relative left flex items-center pointer-events-none ml-4 dark:text-black">
                    ...
                    <div class="relative flex items-center pointer-events-none ml-4 dark:text-black">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
