                        ...
                        <div className="space-y-5">
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    className={`w-full rounded-xl border bg-white hover:border-red-300 dark:hover:border-red-300 text-black font-light placeholder-gray-200 max-w-full min-w-[200px] h-[48px] focus:outline-none focus:border-red-500 ${hasSubmitted && errors.email ? 'border-red-500 shadow-md' : 'border-gray-400 dark:border-gray-400'
                                        }`}
                                    style={{
                                        fontSize: '18px',
                                        fontWeight: 200
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    onChange={handleInputChange}
                                    placeholder="••••••••"
                                    className={`w-full rounded-xl border bg-white -mb-e hover:border-red-300 dark:hover:border-red-300 text-black font-light placeholder-gray-200 max-w-full min-w-[200px] h-[48px] focus:outline-none focus:border-red-500 ${hasSubmitted && errors.password ? 'border-red-500 shadow-md' : 'border-gray-400 dark:border-gray-400'
                                        }`}
                                    style={{
                                        fontSize: '18px',
                                        fontWeight: 200
                                ...
                                <button
                                    ...
                                    className="absolute inset-y-0 end-0 flex items-center z-20 px-3 cursor-pointer text-gray-400 hover:text-red-500 rounded-e-md focus:outline-hidden focus:text-red-500 dark:text-neutral-600 dark:focus:text-red-500">
