...
const ContactForm = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        setApiLoading(true);
        console.log('Form valaidation passed!');
        console.log('Contact data updated:', formData);
        
        setTimeout(() => {
            setApiLoading(false);
            alert('Contact uptated successfully!');
        }, 1000);

    const showLoadding = apiLoading
    ...
    return (
            <div className="min-h-screen bg-white dark:bg-black p-6 absolute top-[90px]" 
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="relative">
                            ...
                            <select 
                                ...
                                onChange={handleInputChange}
                                disabled={showLoading}
                                className={`w-full p-2.5 rounded-xl border border-black bg-transparent text-black transition-all duration-200 max-w-full min-w-[200px] text-base font-normal focus:outline-none focus:border-red-500 ${
                                    ...
                                    <div className="flex space-x-4">
                                        <div className="relative flex-1">
                                            ...
                                            <input 
                                                ...
                                                placeholder="12345"
                                                disabled={showLoading}
                                                className={`w-full p-2.5 rounded-xl border border-black bg-transparent text-black placeholder-gray-400 transition-all duration-200 max-w-full min-w-[100px] text-base font-normal focus:outline-none focus:border-red-500 ${
                        ...
                        <div className="relative">
                            ...
                            <textarea 
                                ...
                                disabled={showLoading}
                                rows={3}
                                className={`w-full p-2.5 rounded-xl border border-black bg-transparent text-black placeholder-gray-400 transition-all duration-200 max-w-full min-w-[200px] text-base font-normal focus:outline-none focus:border-red-500 resize-none ${
                ...
                <div className="text-black dark:text-white font-light block mt-2 absolute left-[40px]"
                    style={{ fontSize: '16px' }}>
                    want to go back? {' '}
                    <a href="/contacts" className="font-light font-normal text-red-500 hover:underline">
                        view contacts.
                    </a>
                </div>
            </div>
