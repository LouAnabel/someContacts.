  ...
  className = ""
    ...
    return (
        <form onSubmit={handleSubmit}>
            <div className=" p-10 flex items-center gap-0 m-0 p-10" ref={dropdownRef}>
                <button 
                    id="dropdown-button" 
                ...
                {isDropdownOpen && (
                    <div className="absolute bg-gray-50 rounded-xl shadow-sm shadow-gray-200 w-44 top-20 dark:bg-white">
                ...
                {/* searchfield */}
                <div className="relative flex-3" ref={searchRef}>
                    <input 
                        type="search" 
                        id="search-dropdown" 
                        value={searchTerm}
                ...
                {/* Submit Button */}
                    <button 
                        type="submit" 
                        className="absolute end-1 py-2.5 px-2.5 text-sm font-medium text-black bg-gray-200 dark:bg-gray-6 dark:bg-gray-200 rounded-e-md hover:bg-red-200 hover:text-red-500 dark:hover:bg-red-200 hover:dark:text-red-500"
                    >
