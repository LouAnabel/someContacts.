                    ...
                    {contactData.links.map((link, index) => {
                      ...
                      if (titleLower === 'instagram') {
                        return (
                          <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="w-10 h-10 flex items-center justify-center group rounded-lg bg-white shadow-md shadow-gray-200 transition-all duration-300 hover:shadow-lg"
                            title="Instagram"
                          >
                      ...
                      return (
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="px-3 py-2 flex items-center justify-center rounded-lg bg-white shadow-md shadow-gray-200 transition-all duration-300 hover:shadow-lg hover:bg-red-50"
                          title={link.title}
                        >
                          <span className="text-sm font-light text-gray-700 hover:text-red-500">
                            {link.title}
                          </span>
                        </a>
                      );
